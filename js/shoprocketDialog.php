...
<head>
  ...
  var prodprices = new Array("<?php echo $prodPrices; ?>");
    ...
    <?php if($cartImgPath): ?>
      ...
      button = "<img src='"+buttonPath+"' title='<?php _e( 'Add to Cart' , 'shoprocket' ); ?>' alt='<?php _e( 'Shoprocket Add To Cart Button' , 'shoprocket' ); ?>'>";
    <?php else: ?>
      button = "<input type='button' class='ShoprocketButtonPrimary' value='<?php _e( 'Add To Cart' , 'shoprocket' ); ?>' />";
    <?php endif; ?>
...
<body id="shoprocket" onLoad="tinyMCEPopup.executeOnLoad('init();');" style="display: none">
    ...
    <div id="panel2" class="panel">
      ...
      <table id="shortCodeList" class="66altColor" cellpadding="0" width="95%">
        ...
        <tr>
          ...
          <td>Allow Shoprocket members to opt out of receiving notifications about the status of their account.</td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td>Show the Shoprocket sidebar widget</td>
        </tr>
