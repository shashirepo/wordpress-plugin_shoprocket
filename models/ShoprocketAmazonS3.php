...
/*
$file = 'headshot.jpg';
$bucket = 'shoprocket_downloads';
$link = ShoprocketAmazonS3::prepareS3Url($bucket, $file, '5 minutes');
echo $link;
*/
class ShoprocketAmazonS3 {
  
  public static function prepareS3Url($bucket, $file, $duration='5 minutes') {

    $awsKeyId = ShoprocketSetting::getValue('amazons3_id');
    $awsSecretKey = ShoprocketSetting::getValue('amazons3_key');
