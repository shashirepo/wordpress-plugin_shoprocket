...
<head>
	...
	<title><?php _e( 'Your Receipt' , 'shoprocket' ); ?></title>
...
<body>
  ...
  <table border="0" cellpadding="0" cellspacing="0">
    <tr>
      <td colspan="3"><p><strong><?php _e( 'Order Number' , 'shoprocket' ); ?>: <?php echo $order->trans_id ?></strong></p></td>
      <!-- <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
    ...
    <tr>
      ...
      <td valign="top">
        ...
        <?php if(!empty($order->phone)): ?>
          Phone: <?php echo ShoprocketCommon::formatPhone($order->phone) ?><br/>
        <?php endif; ?>
    ...
    <tr>
      <td>
        ...
        <p>
          <strong><?php _e( 'Shipping Information' , 'shoprocket' ); ?></strong><br/>
  ...
  <table id="viewCartTable" cellspacing="0" cellpadding="0">
    ...
    <tr>
      ...
      <td class='noBorder' colspan="1" style='text-align: right; font-weight: bold;'><?php _e( 'Subtotal' , 'shoprocket' ); ?>:</td>
      <td class='noBorder' colspan="1" style="text-align: left; font-weight: bold;"><?php echo ShoprocketCommon::currency($order->subtotal); ?></td>
    </tr>
    ...
    <tr>
      <td class='noBorder' colspan='1'>&nbsp;</td>
      <td class='noBorder' colspan="1" style='text-align: center;'>&nbsp;</td>
      <td class='noBorder' colspan="1" style='text-align: right; font-weight: bold;'><?php _e( 'Shipping' , 'shoprocket' ); ?>:</td>
      <td class='noBorder' colspan="1" style="text-align: left; font-weight: bold;"><?php echo ShoprocketCommon::currency($order->shipping); ?></td>
    </tr>
    <?php endif; ?>
    ...
    <?php if($order->discount_amount > 0): ?>
      <tr>
        ...
        <td class='noBorder' colspan="1" style='text-align: right; font-weight: bold;'><?php _e( 'Discount' , 'shoprocket' ); ?>:</td>
        <td class='noBorder' colspan="1" style="text-align: left; font-weight: bold;">-<?php echo ShoprocketCommon::currency($order->discount_amount); ?></td>
      </tr>
    <?php endif; ?>
    ...
    <?php if($order->tax > 0): ?>
      <tr>
        <td class='noBorder' colspan='2'>&nbsp;</td>
        <td class='noBorder' colspan="1" style='text-align: right; font-weight: bold;'><?php _e( 'Tax' , 'shoprocket' ); ?>:</td>
        <td class='noBorder' colspan="1" style="text-align: left; font-weight: bold;"><?php echo ShoprocketCommon::currency($order->tax); ?></td>
      </tr>
    <?php endif; ?>

    <tr>
      <td class='noBorder' colspan='2' style='text-align: center;'>&nbsp;</td>
      <td class='noBorder' colspan="1" style='text-align: right; font-weight: bold;'><?php _e( 'Total' , 'shoprocket' ); ?>:</td>
      <td class='noBorder' colspan="1" style="text-align: left; font-weight: bold;"><?php echo ShoprocketCommon::currency($order->total); ?></td>
    </tr>
  </table>
